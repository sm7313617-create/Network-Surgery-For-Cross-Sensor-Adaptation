<h1 align="center"><code>Network Surgery for Cross-Sensor Adaptation: Transforming Satellite-Trained Models for Rural Drone Imagery</code></h1>
<p align="center">
  <img src="https://readme-typing-svg.herokuapp.com?font=VT323&weight=400&color=00FF00&size=32&center=true&vCenter=true&width=900&pause=1000&lines=Internship+Project+%7C+IDEAS+%40+Indian+Statistical+Institute%2C+Kolkata;Mentor%3A+Dr.+Sujoy+K.+Biswas;Contributors%3A+Ishan+Gain+%7C+Sayan+Mondal+%7C+Pranjal+Basu+%7C+Hardik+Dhalia;Building+Footprint+Extraction+from+Satellite+%26+Drone+Imagery;Deep+Learning+%7C+Computer+Vision+%7C+Remote+Sensing;Phase+1%3A+SpaceNet-1+%7C+8-Band+Multispectral+%26+3-Band+RGB;Trained+on+SpaceNet-1+%7C+6%2C940+WorldView-3+Tiles;Phase+2%3A+Svamitva+Drone+Imagery+%7C+Cross-Domain+Transfer+Learning;Network+Surgery%3A+8-Band+Satellite+%E2%86%92+3-Band+Drone;Custom+8-Band+U-Net+%7C+SAM+ViT-B+%7C+YOLOv8-Nano;Mean+IoU+%3D+0.631+%7C+Phase+2+Accuracy+%3D+92%25;Transfer+Learning%3A+Rio+de+Janeiro+%E2%86%92+Rural+India;Powered+by+Kaggle+2%C3%97+T4+GPUs+%7C+DataParallel+Training" alt="Typing Animation" />
</p>
